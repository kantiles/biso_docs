...
Cette méthodologie rend impossible l'analyse des évolutions d'une année sur l'autre. Un intervalle de 5 ans est necessaire entre deux recensements pour assurer la robustesse de l'analyse. Cet interval passe à 6 ans pour compenser l’absence de l’enquête annuelle de recensement en 2021.

[Pour en savoir plus sur le recensement de la population](https://www.insee.fr/fr/metadonnees/definition/c1486)
...
Avec le millésime 2023, le dispositif Filosofi connaît une refonte majeure et devient FiLoSoFi 2. 

[Plus d'informations sur la version 2023](https://www.insee.fr/fr/metadonnees/source/operation/s2286/presentation)
...
Secret statistique et seuil de diffusion des données issues de FiLoSoFi :
...
Les taux de pauvreté sont diffusés sur les zones de plus de 1000 ménages ou plus de 2000 personnes dans lesquelles il y a au moins 200 personnes et 11 ménages pauvres, ainsi qu'au moins 200 personnes et 11 ménages au-dessus du seuil de pauvreté. 
...
Ici, les résultats sont diffusés s'il y a au moins 200 enfants de moins de trois ans vivant dans un ménage pauvre et déclarant des frais de garde, et s'il y a au moins 200 enfants de moins de trois ans vivant dans un ménage pauvre et ne déclarant pas des frais de garde.
...
[Pour en savoir plus sur la source FiLoSoFi](https://www.insee.fr/fr/metadonnees/source/serie/s1172)
...
[Pour en savoir plus sur Finess](https://Finess.esante.gouv.fr/fininter/jsp/index.jsp)
...
[Pour en savoir plus sur l'enquête EHPA](https://drees.solidarites-sante.gouv.fr/sources-outils-et-enquetes/07-lenquete-aupres-des-etablissements-dhebergement-pour-personnes-agees) 
...
Chaque année depuis 1984, la Drees recueille ainsi auprès des départements des informations sur les bénéficiaires des aides sociales, les personnels de ces collectivités et les dépenses relevant de l’aide sociale départementale.

L’enquête Aide Sociale porte également sur l’activité et le personnels des services de protection maternelle et infantile (PMI).

Enfin, elle comprend également un volet sur à la mesure d’accompagnement social personnalisé (MASP)

[Pour en savoir plus sur l’enquête Aide Sociale](https://drees.solidarites-sante.gouv.fr/sources-outils-et-enquetes/lenquete-aide-sociale-aupres-des-conseils-departementaux)
...
Les Estimations de population ont pour objectif d'estimer :

- La population nationale par sexe et âge au 1er janvier de chaque année ;
- La population régionale et départementale par sexe et groupe d'âges au 1er janvier de chaque année.

Le recensement de la population sert de base aux estimations annuelles de population. Il fixe les niveaux de référence. Entre deux recensements, des estimations provisoires sont réalisées. Elles deviennent définitives une fois les résultats d'un nouveau recensement connus.
...
[Pour en savoir plus sur les estimations de population](https://www.insee.fr/fr/metadonnees/source/serie/s1169)
...
[Pour en savoir plus sur l'état civil](https://www.insee.fr/fr/metadonnees/source/serie/s1170) 
...
[Pour en savoir plus sur le modèle Omphale](https://www.insee.fr/fr/information/3683517)
...
[Pour en savoir plus sur le modèle LIVIA](https://drees.solidarites-sante.gouv.fr/definitions-ressources-et-methodes/projection-de-personnes-agees-dependantes-par-lieu-de-vie-le)

# **Définitions**

## **RSA** {#rsa}

Le revenu de solidarité (RSA) active est une allocation qui complète les ressources initiales du foyer pour qu'elles atteignent le niveau d'un revenu garanti.

Le revenu de solidarité active est en vigueur depuis le 1er juin 2009 en France métropolitaine et depuis le 1er janvier 2011 dans les départements d’outre-mer. Il a remplacé le revenu minimum d’insertion (RMI), l’allocation de parent isolé (API) et les dispositifs associés d’intéressement à la reprise d’activité. 
...
[Pour en savoir plus sur le RSA](https://www.insee.fr/fr/metadonnees/definition/c1718)
...
[Pour en savoir plus sur l'APA](https://drees.solidarites-sante.gouv.fr/definitions-ressources-et-methodes/les-donnees-sur-lallocation-personnalisee-dautonomie-apa)
...
[Pour en savoir plus sur l'AAH](https://www.drees.solidarites-sante.gouv.fr/publications/etudes-et-resultats/laah-un-minimum-social-destine-aux-adultes-handicapes)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1187)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1542)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c2010)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1374)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1458)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1802)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c2021)

## **Niveau de vie** {#niv_vie}

Le niveau de vie, est le revenu disponible par "équivalent adulte". Il est calculé en rapportant le [revenu disponible](#rev_disp) du ménage au nombre d'[unité de consommation](#uc) qui le composent. Toutes les personnes rattachées au même ménage fiscal ont le même revenu disponible par UC (ou niveau de vie).

Le niveau de vie correspond à ce qu’Eurostat nomme « revenu disponible équivalent ».

Les unités de consommation sont généralement calculées selon l'échelle d'équivalence dite de l'OCDE modifiée qui attribue 1 UC au premier adulte du ménage, 0,5 UC aux autres personnes de 14 ans ou plus et 0,3 UC aux enfants de moins de 14 ans.

[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1890)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1285)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1488)
...
[Définition de l'Insee](https://www.insee.fr/fr/metadonnees/definition/c1320)
